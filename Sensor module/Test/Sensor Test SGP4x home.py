...
for i in range (500):
    ...
    sgp1 = (dataSGP[0] << 8) | dataSGP[1]
    sgp2 = (dataSGP[3] << 8) | dataSGP[4]
    x =  1 * (sample - 100)
    delta = sgp1-mean/64.0
    gmean = 1.0/(1.0 + math.exp(x))
    mean = mean + (gmean*delta) / 8.0
    sgp1 = sgp1 - 20000
    sgp1 = sgp1-mean/64.0
    sgp2 = sgp2 - 10000
    print(sgp1, sgp2, x, delta, mean)
